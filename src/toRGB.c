...
void one_YCbCr_mcu_to_rgb(/*struct MCU* mcu_ycbcr,*/uint32_t* mcu_rgb,int nb_horz_blocks_in_mcu,int nb_vertical_blocks_in_mcu){
...
int main(void){
    uint32_t* mcu_rgb=malloc(128*sizeof(uint32_t));
